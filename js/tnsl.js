$(function () {
    ...
    $("#cambiarIdioma").click(function () {
        if (spanish) {
            ...
            $("#proyectos .card-body p").text("This page I created for my friends is designed to manage a record of the football matches we play.");
            $("#habilidades h2").text("Skills");
            $("#confirmacion h5").text("Confirmation");
            $("#confirmacion p").text("Are you sure you want to download the CV?");
            $("#des").text("Download");
            $("#cer").text("Close");
            ...
            $("#proyectos .card-body p").text("Esta página la creé para mis amigos, está diseñada para manejar un registro de los partidos de fútbol que jugamos.");
            $("#habilidades h2").text("Habilidades");
            $("#confirmacion h5").text("Confirmación");
            $("#confirmacion p").text("¿Estás seguro de que deseas descargar el CV?");
            $("#des").text("Descargar");
            $("#cer").text("Close");
